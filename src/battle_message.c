...
static const u8 sATypeMove_Table[NUMBER_OF_MON_TYPES][20] = //17
{
    ...
    [TYPE_ELECTRIC] = _("un mov. ELÉCTRICO"), //PROBLEMA ELECTRICO = ELECT. //RESUELTO
    [TYPE_PSYCHIC]  = _("un mov. PSÍQUICO"),
    [TYPE_ICE]      = _("un mov. HIELO"),
    [TYPE_DRAGON]   = _("un mov. DRAGÓN"),
    [TYPE_DARK]     = _("un mov. SINIESTRO")//PROBLEMA SINIESTRO = SINIEST. //RESUELTO
};
...
const u8 gText_TheGreatNewHope[] = _("The great new hope!\p"); //INGLES
const u8 gText_WillChampionshipDreamComeTrue[] = _("Will the championship dream come true?!\p"); //INGLES
const u8 gText_AFormerChampion[] = _("A former CHAMPION!\p"); //INGLES
const u8 gText_ThePreviousChampion[] = _("The previous CHAMPION!\p");//INGLES
const u8 gText_TheUnbeatenChampion[] = _("The unbeaten CHAMPION!\p");//INGLES
...
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE SE_FLEE}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} fled!"); //INGLES
