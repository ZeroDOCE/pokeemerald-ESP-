...
static const u8 sText_4PlayersNeeded[] = _("Faltan 4\njugadores.");
...
ALIGNED(4) static const u8 sText_ChatDropped[] = _("Se ha interrumpido el chat.\p");
...
ALIGNED(4) static const u8 sText_ChatEnded[] = _("Se ha finalizado el chat.\p");
...
ALIGNED(4) static const u8 sText_NameWantedOfferLv[] = _("NOMBRE{CLEAR_TO 60}QUIERE{CLEAR_TO 110}{CLEAR_TO 198}NV.");
